...
task consumer(int i)
{
  ...
  std::cout << "consumer " << i << " saw result: " << value << std::endl;
}

/**
  * - Try to get a feel of what the code does
  * - Run the producer in a different thread
  * - add print statements to determine what code runs on what thread
  */
void test_1()
{
  consumer(1);
  consumer(2);
  producer(5);
  // uncomment the following line when you change producer to run in a different thread and don't forget to join your thread
...
void coroutines_ex2()
{
  std::cout << "coroutines_ex2" << std::endl;
  test_1();
}
